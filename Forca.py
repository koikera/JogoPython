# -*- coding: utf-8 -*-
"""
Created on Tue Aug  3 22:30:10 2021
...
def jogar():
    ...
    titulo()
    #carregar palavra do arquivo .txt
    palavra_secreta = carregar_palavra()
    #pega a posicao da palavra
    letras_acertadas = posicao(palavra_secreta)
